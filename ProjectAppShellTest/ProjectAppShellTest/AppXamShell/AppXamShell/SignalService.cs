...
namespace AppXamShell
{
    public class SignalRService
    {
        ...
        public delegate void MessageReceivedHandler(object sender, MessageModel message);
        ...
        void AddNewMessage(JObject message)
        {
            ...
            {
                User = message.GetValue("name").ToString(),
                Message = message.GetValue("text").ToString(),
